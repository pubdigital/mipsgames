...
skipSeedInit:
    ...
    # Elegir tipo aleatorio de obstáculo (0 = cono, 1 = piedra)
    li $a0, 2
    jal getRandom
    sw $v0, obsType
...
collision:
    ...
    li $a0, 2           # Rango: 0 a 1
    jal getRandom
    sw $v0, obsType     # Guardar el resultado (ahora SÍ se usa)
...
# Retorna en $v0 un número entre 0 y $a0-1
getRandom:
    addi $sp, $sp, -4
    sw $ra, 0($sp)
...
obsType: .word 0        # 0 = cono, 1 = piedra
