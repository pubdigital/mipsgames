...
drawHearts:
    ...
    li $s6, 52            # X inicial (más a la derecha para que quepan 3 corazones)
...
heartLoop:
    ...
    # Calcular X de este corazón (separados por 9 píxeles)
    move $a0, $s6
    li $t7, 9
    mult $t8, $t7
    mflo $t7
...
drawThisHeart:
    # Guardar posición base y colores
    move $s0, $a0
    move $s1, $a1
...
# Sprite de explosión 16x16 (simple pero efectivo)
explosion_data:
    .word
